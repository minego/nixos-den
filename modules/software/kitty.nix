	...
	module = { host, pkgs, lib, config, ... }: {
		...
		config.environment.etc = {
			"xdg/kitty/kitty.conf".text = ''
				...
				# Use 'viewer', which is my script that uses neovim
                scrollback_pager viewer
				'';
...
in {
	# Kitty is included in the main desktop aspect
	flake.modules.nixos.software_kitty		= module;
